...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 3,
                "vtp_instanceDestinationId": "AW-11208572790",
                "tag_id": 9
            }, {
                "function": "__ogt_conv_def",
                "priority": 2,
                "vtp_matchingRules": "[\"and\",[\"startsWith\",[\"variable\",\"pageLocation\",[\"map\",\"stripProtocol\",true]],\"getprodentimforteeth.com\"],[\"startsWith\",[\"variable\",\"pageLocation\",[\"map\",\"stripProtocol\",true]],\"getprodentimforteeth.com\"]]",
                "vtp_conversionLabel": "ko4OCK7T8agYEPb-1OAp",
                "vtp_instanceDestinationId": "AW-11208572790",
                "tag_id": 8
            }, {
                "function": "__ogt_conv_def",
                "priority": 1,
                "vtp_matchingRules": "[\"and\",[\"startsWith\",[\"variable\",\"pageLocation\",[\"map\",\"stripProtocol\",true]],\"getprodentimforteeth.com\"],[\"startsWith\",[\"variable\",\"pageLocation\",[\"map\",\"stripProtocol\",true]],\"getprodentimforteeth.com\"]]",
                "vtp_conversionLabel": "O0BOCKvT8agYEPb-1OAp",
                "vtp_instanceDestinationId": "AW-11208572790",
                "tag_id": 7
            }, {
                "function": "__rep",
                "vtp_containerId": "AW-11208572790",
        ...
        "runtime": [
            ...
            [50, "__ogt_conv_def", [46, "a"],
                ...
                [41, "h"],
                [3, "h", [30, [17, [15, "a"], "instanceDestinationId"],
                    [17, ["e"], "containerId"]
                ]],
                [22, [1, [17, [15, "a"], "conversionLabel"],
                        [20, [2, [15, "h"], "indexOf", [7, "AW-"]], 0]
                    ],
                    [46, [3, "h", [0, [15, "h"],
                        [0, "/", [17, [15, "a"], "conversionLabel"]]
                    ]]]
                ],
                [52, "i", [8]],
                [52, "j", [8, "eventId", [17, [15, "a"], "gtmEventId"]]],
                [52, "k", [51, "", [7],
                    [22, ["c", [17, [15, "a"], "matchingRules"]],
                        [46, ["g", [15, "h"], "conversion", [15, "i"],
                            [15, "j"]
                        ]]
                    ]
                ]],
                ["f", [15, "h"], "config", [15, "k"]],
                [22, [16, [15, "d"], "enableAdsHistoryChangeEvents"],
                    [46, ["b", [15, "k"],
                        [8, "interval", 1000]
                    ]]
                ],
    ...
    */
    ...
    ni.ee = Number("0") || 0;
    ni.ia = "dataLayer";
    ni.Rj = "ChEI8JfGpwYQ27mV+qyw/oj5ARInAKaV/omworFJBrWGD/Ptk0fomWVXF+bLw7fqeF/vuouwIH6Z7CMxGgIxBQ\x3d\x3d";
    var qi = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    var jj;
    try {
        jj = JSON.parse(wb("eyIwIjoiQkQiLCIxIjoiQkQtQyIsIjIiOmZhbHNlLCIzIjoiZ29vZ2xlLmNvbS5iZCIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
    } catch (a) {
        M(123), ij(2), jj = {}
    }
    var kj = function() {
    ...
    var Xz = function(a, b) {
        ...
        Wz = function(a) {
            ...
            return function(d) {
                ...
                f[e.source] = !0;
                f[d.source] = !0;
                if (!f.popstate || !f.hashchange || e.P != d.P) {
                    var g = {
                        "gtm.historyChangeSource": d.source,
                        "gtm.oldUrlFragment": c.P,
                        "gtm.newUrlFragment": d.P,
    ...
    var bA = function(a, b) {
        ...
        if (!d || 0 > d) d = 0;
        var e = pd(a);
        if (Rx("pix.ehl", "init", !1)) {
            var f = Rx("pix.ehl", "reg");
            f && f(d, e);
            return
        }
        var g = function(k) {
            for (var m = 0; m < Vz.length; m++) Vz[m](k)
        };
        aA(g);
        $z(g);
        Yz("pushState", g);
    ...
    function JB(a) {
        ...
        L(this, "get_url");
        var c = JSON.parse(a);
        if (!Da(c)) throw Error("Invalid JSON string for rules, must be a single JSON array.");
        IB || (IB = new Ie);
        b = !!IB.execute(c);
        return b
    }
    ...
    function lD() {
        var a = new qb;
        L(this, "read_container_data"), a.set("containerId", 'AW-11208572790'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", bg), a.set("previewMode", dg), a.set("environmentMode", cg), Q(92) && a.set("firstPartyServing", wi || yi), Q(94) && a.set("containerUrl", Dc), a.Bb();
        return a
    }
    ...
    function QF(a, b, c) {
        K(J(this), ["targetId:!string", "commandType:!string", "callback:?Fn"], arguments);
        if (0 > PF.indexOf(b)) throw Error("registerGtagCommandListener failed, unsupported commandType: " + b);
        var d = pd(c),
            e = b,
            f = cp(mk(a), !0);
        if (f) {
    ...
    function dG(a, b, c) {
        ...
        for (var d = b.split("."), e = Xv(a), f = 0; f < d.length - 1; f++) {
            ...
            else if (!kb(e[d[f]])) throw Error("setRemoteConfigParameter failed, path contains a non-object type: " + d[f]);
            e = e[d[f]]
        }
        e[d[f]] = pd(c, this.h, 1);
    }
